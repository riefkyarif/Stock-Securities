...
// untuk saham
void portofolio();																// fungsi untuk menampilkan portofolio pengguna
void menuportofolio();															// fungsi menu portofolio
void cetakporto();																// fungsi untuk mencetak portofolio ke dalam txt
void belisaham();																// fungsi menu membeli saham
void insert_end();																// fungsi membeli saham
void jualsaham();																// fungsi menu menjual saham
void delete_pos();																// fungsi menjual saham
int jual, num, i;																// jual = variabel untuk menjual saham, num = variabel untuk merandomisasi, i = variabel untuk looping randomisasi 
void searching();


// untuk data akun
char idakun[10];																// variabel untuk menginput id akun
char password[12];																// variabel untuk menginput password
int cash = 0;																	// menginisiasi nilai cash awal = 0
void displaycash();																// fungsi menampilkan id dan sisa cash di menu utama
void fordelay(int j);															// fungsi untuk memberi delay agar loading ada titik yang bergerak
void tambahkurangdana();														// fungsi untuk topup/withdrawl cash
void help();																	// fungsi untuk menampilkan help
...
void updatepatch();																// fungsi untuk mengupdate aplikasi
void enQueue1(PembaruanPtr *headPtr1, PembaruanPtr *tailPtr1, char nama[20]); 	// fungsi Memasukan/install Patch keamanan baru ke queque dengan passing SahamPtr *headPtr1, SahamPtr *tailPtr1 dan char nama[20]
void deQueue1(PembaruanPtr *headPtr1, PembaruanPtr *tailPtr1); 					// fungsi Mengeluarkan/uninstall Patch keamanan baru dari queque dengan passing nilai SahamPtr *headPtr1 dan SahamPtr *tailPtr1
int isEmpty1(PembaruanPtr headPtr1);											// fungsi untuk mengecek nilai headPtr1
void printQueue1(PembaruanPtr currentPtr); 										// fungsi untuk mencetak Antrian Ekonomi
PembaruanPtr headPtr1 = NULL;													// menginisialisasi headptr menjadi null
PembaruanPtr tailPtr1 = NULL;													// menginisialisasi tailptr menjadi null
